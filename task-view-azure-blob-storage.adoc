...
.Étapes
. https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-azure.html["Installer un agent de console"^]dans le compte Azure où vous souhaitez afficher vos comptes de stockage Azure Blob.
